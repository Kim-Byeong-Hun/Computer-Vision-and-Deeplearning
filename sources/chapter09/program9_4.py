...
input_dir = 'C:/Users/qudgn/Computer-Vision-and-Deeplearning/sources/chapter09/images/'
target_dir = 'C:/Users/qudgn/Computer-Vision-and-Deeplearning/sources/chapter09/annotations/trimaps/'
img_siz = (160,160)
n_class = 3
batch_siz=32
...
class OxfordPets(keras.utils.Sequence):
    ...
    def __len__(self):
        return len(self.label_path)//self.batch_size
    
    def __getitem__(self, idx):
        i = idx*self.batch_size
        batch_img_paths = self.img_paths[i:i+self.batch_size]
        batch_label_paths = self.label_path[i:i+self.batch_size]
